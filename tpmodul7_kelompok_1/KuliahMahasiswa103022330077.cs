...
internal class KuliahMahasiswa103022330077
{
    ...
    {
        var dataJson = File.ReadAllText("../../../tp7_2_103022330077.json");
    ...
    class Program
    {
        ...
        {
            KuliahMahasiswa103022330077 kuliah = new KuliahMahasiswa103022330077();
            kuliah.readJSON() ;
        }
    }
}